...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Guard clause: if any required element is missing, exit early (prevents red X / crashes)
  if (!track || !prevBtn || !nextBtn || !dotsContainer) {
    console.warn('Advert carousel elements not found – skipping initialization.');
    return;
  }
  ...
  // Optional: initial call to make sure first dot is active
  updateCarousel();
});
